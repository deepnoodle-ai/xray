  ...
  window.fetch = async (input, init) => {
        ...
        if (bodyStr !== null) {
          if (bodyStr.length > cfg.maxBodySize) {
            ...
            try {
              ...
              request.requestBody = redactBodyFields(parsed, cfg.redactBodyFields);
            } catch {
    ...
    try {
      ...
      if (cfg.captureHeaders) {
        ...
        updates.responseHeaders = redactHeaders(responseHeaders, cfg.redactHeaders);
      }
          ...
          try {
            ...
            if (text.length > cfg.maxBodySize) {
              ...
              try {
                ...
                updates.responseBody = redactBodyFields(parsed, cfg.redactBodyFields);
              } catch {
